...
const TopicFilterBar = ({ topics, active, onSelect }: TopicFilterBarProps) => {
  ...
  return (
    <div className="sticky top-[37px] md:top-[82px] z-40 bg-background border-b border-border pt-2 pb-2 mb-4 overflow-x-auto scrollbar-none -mx-4 px-4 md:mx-0 md:px-0">
